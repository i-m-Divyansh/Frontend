...
const Signup = () => {
  ...
  const validate = () => {
    ...
    if (firstName === "") {
      value = false;
      err.firstName = "Enter Firstname First!";
    }

    if (lastName === "") {
      value = false;
      err.lastName = "Enter Lastname First!";
    }
  ...
  const loginHandler = async (e) => {
    ...
    if (validate()) {
      ...
      axios({ method: "POST", url: "/signup", data: FormData })
        .then((response) => {
          ...
          <div className={styles.form_wrapper}>
            <form onSubmit={loginHandler} className={styles.form}>
              <div className={styles.greeting_wrapper}>
                <p className={styles.general_msg}>Signup to continue</p>
              </div>

              <InputLabel className={styles.label}>Firstname</InputLabel>
              <TextField
              ...
              <InputLabel className={styles.label}>Lastname</InputLabel>
              <TextField
